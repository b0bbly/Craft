...
public class PlayerControl : MonoBehaviour
{
	...
	//this start is only added by the health and mana tools
	void Start()
	{}

	/*
	//this method calculates the health range from 1 to 10 for the bar based on min/max and current health
